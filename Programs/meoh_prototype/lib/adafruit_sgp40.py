...
_READ_CMD = [0x26, 0x0F, 0x80, 0x00, 0xA2, 0x66, 0x66, 0x93]
...
class SGP40:
    ...
    def raw(self):
        ...
        read_value = self._read_word_from_command(delay_ms=30)
        self._command_buffer = bytearray(2)
        return read_value[0]

    def _read_word_from_command(self, delay_ms=10, readlen=1):
